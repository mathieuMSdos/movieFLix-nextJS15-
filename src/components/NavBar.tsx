...
const NavBar = () => {
  ...
  return (
    <nav className="h-full w-full flex">
      <Link href="/">
        {/* le logo */}
        <div className="h-full w-fit flex gap-2  p-2 items-center cursor-pointer  ">
          <Image
      ...
      <ul className="h-full w-full flex justify-center items-center gap-4  text-slate-100 ">
        <li>
          <Link
            ...
            className={
              pathname === "/"
                ? "relative before:content-['] before:absolute before:top-6 before:w-full before:h-1 before:bg-white "
                : ""
            }
          >
            Accueil
